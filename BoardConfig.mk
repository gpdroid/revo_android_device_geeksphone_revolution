...
TARGET_RELEASETOOL_OTA_FROM_TARGET_SCRIPT := device/geeksphone/revolution/releasetools/ota_from_target_files

# Security
BUILD_WITH_WATCHDOG_DAEMON_SUPPORT := true
HAVE_SELINUX := true
BOARD_SEPOLICY_DIRS += device/geeksphone/revolution/sepolicy
...
BOARD_KERNEL_CMDLINE := init=/init pci=noearly earlyprintk=nologger loglevel=0 hsu_dma=7 kmemleak=off androidboot.bootmedia=$(BOARD_BOOTMEDIA) androidboot.hardware=$(TARGET_DEVICE) $(cmdline_extra) ip=50.0.0.2:50.0.0.1::255.255.255.0::usb0:on vmalloc=172M
...
WIFI_DRIVER_FW_PATH_STA   := "/system/etc/firmware/fw_bcmdhd_4330.bin"
WIFI_DRIVER_FW_PATH_AP    := "/system/etc/firmware/fw_bcmdhd_4330_apsta.bin"
WIFI_DRIVER_MODULE_ARG := "iface_name=wlan0 firmware_path=/system/etc/wifi/fw_bcmdhd_4330.bin"
...
TARGET_RECOVERY_INITRC := $(LOCAL_PATH)/init/recovery.init.revolution.rc
